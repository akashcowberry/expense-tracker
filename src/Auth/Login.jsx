      ...
      <div className="space-y-2 sm:space-y-3">
        ...
        <div className="relative">
          <input
            ...
            required
            className="w-full px-4 py-3 sm:py-4 pl-11 pr-4 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 transition-all duration-300 outline-none bg-white/50 shadow-sm hover:shadow-md focus:shadow-lg"
          />
